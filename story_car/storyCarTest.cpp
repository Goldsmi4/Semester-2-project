    ...
    int killLooter();
    {
        ...
        switch(input)
        {
            case 1:
                ...
                cout << "on your arms. After looting the house you leave and go back to your car." << endl;
                route_path();
                break;
            case 2:
...
int lootRifle()
{
    ...
    switch(input)
    {
        case 1:
            ...
            cout << "in one of his drawers. you take them and try them on the padlock" << endl;
            managerLock()
            break;
            
        case 2:
            cout << "You look around the room, in the drawers of the desk, on the shelves and the cupboards." << endl;
            cout << "Nothing. You hear the group approaching. " << endl;
...
int managerLock()
{
    ...
    cout << "/t 2: Just a few more."
    cin >> input;
    switch(input)
    {
        case 1:
            cout << "You drop the keys you found and run to your car. You get in and drive off" << endl;
